...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: aGLdP3kNDzIT/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns___98Vau)}>
        <div className={classNames(projectcss.all, sty.column__qeZ9T)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__db6Rq)}>
          <div className={classNames(projectcss.all, sty.columns__uNrG)}>
            <div className={classNames(projectcss.all, sty.column__ai8LM)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__f6SEw)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__ua5UV)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__nVEwq)}>
                {renderPlasmicSlot({
